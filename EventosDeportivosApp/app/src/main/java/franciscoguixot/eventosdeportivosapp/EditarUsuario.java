...
public class EditarUsuario extends AppCompatActivity {
    ...
    public void goPerfil(View view) {
        if (nombre.getText().toString().equals("") || apellidos.getText().toString().equals("")
            ...
            if (contraseña.getText().toString().equals(contraseñaRepetida.getText().toString())) {
                Intent i = new Intent(EditarUsuario.this, Perfil.class);
    ...
    public void calcelPerfil(View view) {
        AlertDialog.Builder alerta = new AlertDialog.Builder(this);
        alerta.setMessage("¿Está seguro que desea cancelar?")
                .setTitle("CANCELAR")
                .setPositiveButton("Sí", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent i1 = new Intent(EditarUsuario.this, Perfil.class);
                        startActivity(i1);
                    }
                })
